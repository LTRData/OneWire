...
//
public class DS2482Channel(DS2482 ds2482, DS2482Channel.OneWireChannel channel)
{
    ...
    private IOneWireDevice AddOneWireDevice(Dictionary<byte, Type> oneWireDeviceTypes)
    {
        ...
        {
            var device = (IOneWireDevice)Activator.CreateInstance(type)!;

            var address = (byte[])ROM_NO.Clone();
    ...
    {
        Span<byte> rom_backup = stackalloc byte[8];
    ...
    public bool OneWireReset()
    {
        ...
        if(!ds2482.IsCorrectChannelSelected(channel))
        {
            SelectDS2482Channel();
        }

        ds2482.I2cDevice.WriteByte(FunctionCommand.ONEWIRE_RESET);
    ...
    private void SelectDS2482Channel()
    {
        ...
        switch (channel)
        {
            case OneWireChannel.Channel_IO0:
                ds2482.I2cDevice.WriteRead([FunctionCommand.CHANNEL_SELECT, ChannelSelect.Channel_IO0], statusBuffer);
            ...
            case OneWireChannel.Channel_IO1:
                ds2482.I2cDevice.WriteRead([FunctionCommand.CHANNEL_SELECT, ChannelSelect.Channel_IO1], statusBuffer);
            ...
            case OneWireChannel.Channel_IO2:
                ds2482.I2cDevice.WriteRead([FunctionCommand.CHANNEL_SELECT, ChannelSelect.Channel_IO2], statusBuffer);
            ...
            case OneWireChannel.Channel_IO3:
                ds2482.I2cDevice.WriteRead([FunctionCommand.CHANNEL_SELECT, ChannelSelect.Channel_IO3], statusBuffer);
            ...
            case OneWireChannel.Channel_IO4:
                ds2482.I2cDevice.WriteRead([FunctionCommand.CHANNEL_SELECT, ChannelSelect.Channel_IO4], statusBuffer);
            ...
            case OneWireChannel.Channel_IO5:
                ds2482.I2cDevice.WriteRead([FunctionCommand.CHANNEL_SELECT, ChannelSelect.Channel_IO5], statusBuffer);
            ...
            case OneWireChannel.Channel_IO6:
                ds2482.I2cDevice.WriteRead([FunctionCommand.CHANNEL_SELECT, ChannelSelect.Channel_IO6], statusBuffer);
            ...
            case OneWireChannel.Channel_IO7:
                ds2482.I2cDevice.WriteRead([FunctionCommand.CHANNEL_SELECT, ChannelSelect.Channel_IO7], statusBuffer);
        ...
        ds2482.SetSelectedChannel(channel);
    }
    ...
    public byte ReadStatus(bool setReadPointerToStatus = false)
    {
        ...
        {
            ds2482.I2cDevice.WriteRead([FunctionCommand.SET_READ_POINTER, RegisterSelection.STATUS], statusBuffer);
        }
        else
        {
            ds2482.I2cDevice.Read(statusBuffer);
        }
        ...
        do
        {
            ...
            if (Stopwatch.GetTimestamp() - stopWatch > ticksPerMillisecond)
            {
    ...
    void WaitForOneWireReady()
    {
        ...
        do
        {
            // 5000 milliseconds passed
            if ((Stopwatch.GetTimestamp() - stopWatch) / ticksPerMillisecond > 5000)
            {
                throw new InvalidOperationException("One Wire bus busy for too long");
            }

            ds2482.I2cDevice.WriteRead([FunctionCommand.SET_READ_POINTER, RegisterSelection.STATUS], status);
    ...
    public void OneWireWriteByte(byte byte_value)
    {
        ...
        ds2482.I2cDevice.Write([FunctionCommand.ONEWIRE_WRITE_BYTE, byte_value]);
    ...
    public void OneWireWriteBit(bool bit_value)
    {
        ...
        ds2482.I2cDevice.Write([FunctionCommand.ONEWIRE_SINGLE_BIT, byte_value]);
    ...
    public byte OneWireReadByte()
    {
        ...
        ds2482.I2cDevice.WriteByte(FunctionCommand.ONEWIRE_READ_BYTE);
        ReadStatus();
        ds2482.I2cDevice.WriteRead([FunctionCommand.SET_READ_POINTER, RegisterSelection.READ_DATA], buffer);
        return buffer[0];
    }
