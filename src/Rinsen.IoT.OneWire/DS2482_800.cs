...
public class DS2482_800 : DS2482
{
    ...
    public override bool IsCorrectChannelSelected(OneWireChannel channel) => _selectedChannel == channel;

    public override void SetSelectedChannel(OneWireChannel channel) => _selectedChannel = channel;
}
